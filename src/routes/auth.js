...
const {login, signup, users, recover_session, updateRole, deleteUser, passwordRecovery, change_password, changePassword, } = require("../controllers/auth");
...
function auth(app) {
  ...
  authRouter.get('/recover', authToken, recover_session ); /* ultima feature para que la sesion se pueda recuperar, implementando middleware que recibe el token al hacer login */
